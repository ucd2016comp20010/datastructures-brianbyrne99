...
public class LinkedCircularQueue<E> implements Queue<E> {
	...
	public LinkedCircularQueue() { //empty consrtuctor
	}
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<5;i++)
		    ...
		    System.out.println("Size : "+que.toString());
	...
	public void rotate() { //similar to the circularly linked list fist becomes last and second becomes first
		list.rotate();
	}
