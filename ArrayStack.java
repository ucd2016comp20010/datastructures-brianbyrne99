...
public class ArrayStack<E> implements Stack<E> {
	...
	public ArrayStack() {
		this(CAPACITY);  //setting stack capacity
	}
	...
	@Override
	public void push(E e) {  //adding to the top of the stack
		if(t>= CAPACITY-1) {
	...
	@Override
	public E top() {  //returns top element in the stack (last entry)
		if(t<0)
	...
	@Override
	public E pop() {        //removing the top elements of the stack
		if(t<0) {
